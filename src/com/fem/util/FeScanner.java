...
public class FeScanner {
    ...
    public FeScanner(String fileIn) {
        ...
        try {
            ...
            com.fem.util.UTIL.errorMsg("Input file not found: " + fileIn);
        }
    ...
    public int readInt() {
        if (!es.hasNextInt()) com.fem.util.UTIL.errorMsg(
    ...
    public double readDouble() {
        if (!es.hasNextDouble()) com.fem.util.UTIL.errorMsg(
    ...
    public void moveAfterLineWithWord(String word) {
        ...
        com.fem.util.UTIL.errorMsg("moveAfterLineWithWord cannot find: "
                + word);
    }
