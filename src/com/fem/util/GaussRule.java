...
public class GaussRule {
    ...
    private static final double a = 0.7587869106393281,
            b = 0.7958224257542215;
    private static final double[] X14 =
            {-a, a, -a, -a, a, -a, a, a, -b, b, 0, 0, 0, 0};
    private static final double[] Y14 =
            {-a, -a, a, -a, a, a, -a, a, 0, 0, -b, b, 0, 0};
    private static final double[] Z14 =
            {-a, -a, -a, a, -a, a, a, a, 0, 0, 0, 0, -b, b};
    private static final double Wa = 0.3351800554016621,
            Wb = 0.8864265927977839;
    ...
    public GaussRule(int nGauss, int nDim) {
        ...
        if (!((nGauss>=1 && nGauss<=3) || nGauss==14))
            com.fem.util.UTIL.errorMsg("nGauss has forbidden value: "
                    + nGauss);
        if (!(nDim>=1 && nDim<=3)) com.fem.util.UTIL.errorMsg(
                "GaussRule: nDim has forbidden value: "
                    + nDim);
